(function (window){  //传入window，提高变量的查找效率
    function TouchSim(ele){  //这个函数就是对外提供的接口。
        //调用这个函数的原型对象上的_init方法，并返回
        return TouchSim.prototype._init(ele);
    }
    TouchSim.prototype = {
...
/*
用法：
TouchSim(ele).tap(function (e){
    console.log("单击事件")
})
TouchSim(ele).longTag(function (){
    console.log("长按事件");
})

TouchSim(ele).slideLeft(function (e){
    console.log(this);
